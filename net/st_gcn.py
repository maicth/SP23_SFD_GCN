...
from net.utils.sfd_gcn import TemporalGatedUnit, SEBlock, AttentionBlock
...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, num_class, graph_args,
        ...
        self.st_gcn_networks = nn.ModuleList((
            ...
            st_gcn(96, 128, kernel_size, 1, **kwargs),
        ...
        self.attention_block = AttentionBlock(0.5)
        # fcn for prediction
    ...
    def forward(self, x):
        ...
        # data normalization
        N, C, T, V, M = x.size()
        x = x.permute(0, 4, 3, 1, 2).contiguous() # 04312 NMVCT
        x = x.view(N * M, V * C, T)
        x = self.data_bn(x)
        x = x.view(N, M, V, C, T)
...
class st_gcn(nn.Module):
    ...
    def __init__(self,
        ...
        # self.attention_block = AttentionBlock(0.3)
